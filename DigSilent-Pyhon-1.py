...
try:
    ...
    print_and_log("Could not show GUI", f)
...
if summary_grid:
    ...
    print_and_log(f"[Inicial] Pérdidas totales reactivas: {perdidas_totales_Q:.2f} MVAr", f)
else:
...
# ============================================================
lineas_red = [
    line for line in grid.GetContents("*.ElmLne")
...
# ============================================================
f.close()
print("\nScript finalizado. Resultados guardados en:", output_file)
print("PowerFactory will stay open.")
print("Press Enter in this terminal to close the script (PowerFactory will remain open)...")

# This keeps the Python process alive → PowerFactory stays open
input()